...
import type { Direction, LeaderboardEntry } from '../types/game';
...
export function Game() {
  ...
  return (
    ...
    >
        ...
        {showGameOverOverlay && (
          <Overlay color="rgba(10,8,4,0.88)">
            <OverlayMessage title="GAME OVER" subtitle={`Final score: ${state.score}`} accent="#c8b86a">
              ...
              <OverlayBtn onClick={openLeaderboard} variant="amber">Scores</OverlayBtn>
            </OverlayMessage>
          </Overlay>
        )}
      </div>
      ...
      <LeaderboardPopup isOpen={leaderboardOpen} entries={leaderboard} onClose={closeLeaderboard} />
    </div>
  );
}
